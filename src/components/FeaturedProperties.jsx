    ...
    <section className="bg-[#141414] text-white body-font">
      <div className="max-w-6xl px-5 py-12 mx-auto">
        ...
        <div className="flex flex-wrap justify-between items-center w-full mb-12">
          ...
          <button className="bg-white/5 text-white font-medium px-6 rounded-sm transition duration-300 border border-white/10 hover:border-indigo-500 text-md py-2">
            View All Properties
          </button>
        </div>
